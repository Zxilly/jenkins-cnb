...
object CnbClientFactory {
    ...
    internal fun resolveToken(
        ...
        val credential =
            ...
            ) ?: throw IllegalArgumentException("CNB credential '$credentialsId' was not found in this item context")
        ...
        return when (credential) {
            ...
            is StandardUsernamePasswordCredentials -> {
                ...
                throw IllegalArgumentException(
                    "CNB credential '$credentialsId' must be secret text or username/password",
                )
            }
        }
    }
