...
class CnbSCMSourceRequest(
    ...
    val fetchPullRequestLabels: Boolean = context.wantsPullRequestLabels
    val fetchPullRequestAuthorAccess: Boolean = context.wantsPullRequestAuthorAccess
    ...
    var pullRequestLabels: Map<String, Set<String>> = emptyMap()
    var pullRequestAuthorAccess: Map<String, Set<String>> = emptyMap()
