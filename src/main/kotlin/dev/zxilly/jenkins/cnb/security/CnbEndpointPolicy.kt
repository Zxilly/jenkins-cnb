...
object CnbEndpointPolicy {
    ...
    /** Resolves and validates in one operation so a transport can connect to these exact values. */
    fun resolvePublicAddresses(host: String): Array<InetAddress> = requirePublicAddresses(InetAddress.getAllByName(host))

    internal fun requirePublicAddresses(addresses: Array<InetAddress>): Array<InetAddress> {
