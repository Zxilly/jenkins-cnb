...
class CnbHmacTest {
    ...
    @Test
    fun `encodes non ASCII secrets as UTF-8 without changing the signature contract`() {
        val body = "{\"event\":\"push\",\"message\":\"你好\"}".toByteArray()

        assertTrue(
            CnbHmac.verify(
                body,
                "sha256=d21d5fc8150f29f0a75c0535568152c0c92865005bf80f97fdd205cacf7f890d",
                listOf("密钥-jenkins-🔐".toCharArray()),
            ),
        )
    }
}
